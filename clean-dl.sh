...
document_extensions=("doc" "bibtex" "docx" "xls" "xlsx" "ppt" "pptx" "pdf" "cls" "txt" "odt" "ods" "odp" "odg" "odf" "rtf" "tex" "texi" "tex" "log" "csv" "tsv" "html" "htm" "css" "js" "json" "xml" "sql" "xlsm" "xlx")
